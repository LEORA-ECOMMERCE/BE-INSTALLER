...
exports.createProductSchema = joi_1.default.object({
    ...
    productImages: joi_1.default.alternatives()
        .try(joi_1.default.array().items(joi_1.default.string()).optional(), joi_1.default.string())
        .optional(),
    ...
    productCategoryId: joi_1.default.number().integer().min(0).default(0).messages({
    ...
    productSubCategoryId: joi_1.default.number().integer().min(0).default(0).messages({
    ...
    productDiscount: joi_1.default.number().min(0).max(100).optional().default(0).messages({
...
exports.updateProductSchema = joi_1.default.object({
    ...
    productDescription: joi_1.default.string().optional().allow(''),
    productImages: joi_1.default.alternatives()
        .try(joi_1.default.array().items(joi_1.default.string()), joi_1.default.string())
        .optional()
        .default([]),
    productPrice: joi_1.default.number().optional().messages({
        'number.base': 'Harga produk harus berupa angka',
        'number.integer': 'Harga produk harus bilangan bulat',
        'number.min': 'Harga produk tidak boleh kurang dari 0'
    }),
